...
class Antispam
{
    ...
    var $img_path = './tmp/captcha/'; // Image path
    ...
    function get_antispam_image($override = array())
    {
        ...
        $img_markup = '<img src="' . $this->img_url . $img_name . '" width=" ' . $this->img_width . '" height="' . $this->img_height . '" style="border:0;" alt=" " />';
